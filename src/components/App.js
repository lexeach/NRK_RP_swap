...
class App extends Component {
  ...
  async loadEthSwapWebSocket() {
    ...
    const URL = `wss://Bsc.infura.io/ws/v3/2596630cf90848f198341f6e1ba5a0bc/testnet`;
    ...
    if (web3Socket) {
      ...
      const ethSwapWebSocket = await new web3Socket.eth.Contract(
        EthSwap,
        "0x4787fB40B47515a45FfbfAAFC1db2eF50e3D25C6"
      );
  ...
  async loadBlockchainData() {
    ...
    const token = new web3.eth.Contract(
      Token,
      "0x2572ed0e4F252212Ce5D86CD79b15C3F199cf653"
    );
    this.setState({ token });
